test_that("Simple level constant correct", {
  ...
  secondStageIntegral <- integrate(f = getOptimalConditionalError, lower = 0.001, upper = 0.5,
            design)$value
  ...
  # This is the type I error at the second stage
  secondStageIntegral <- integrate(f = getOptimalConditionalError, lower = 0, upper = 1,
                                   design)$value
